...
const { ROLE_ADMIN, ROLE_OPERATIONS_TEAM, ROLE_EMPLOYEE, ROLE_MANAGER } = require('../utilities/constants')
...
router.get("/get-all-lead-partners", authenticate([ROLE_ADMIN,ROLE_MANAGER,ROLE_EMPLOYEE,ROLE_OPERATIONS_TEAM]), LeadPartnerController.getAllLeadPartners)
