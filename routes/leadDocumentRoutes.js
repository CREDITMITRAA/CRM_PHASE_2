...
router.get('/get-lead-documents-by-lead-id',authenticate([ROLE_ADMIN,ROLE_MANAGER,ROLE_EMPLOYEE,ROLE_OPERATIONS_TEAM,ROLE_VIEWER]), LeadDocumentController.getLeadDocumentsByLeadId)
